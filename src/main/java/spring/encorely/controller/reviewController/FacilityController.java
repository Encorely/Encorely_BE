...
public class FacilityController {
    ...
    public ApiResponse<List<ReviewResponseDTO.GetFacility>> getFacilities(@AuthenticationPrincipal UserDetails userDetails,
        ...
        return ApiResponse.onSuccess(facilityService.getFacilities(currentUserId, hallId, keyword, type, sortKey, pageable));
    }
